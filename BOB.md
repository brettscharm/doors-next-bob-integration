...
Note: The `[AI Generated]` prefix and `[AI Generated by Bob]` content tag are added automatically by the tool — you do NOT need to add them to titles or content.
...
- ALL created artifacts are tagged with **[AI Generated by Bob]** in the content body (done by the tool, not by you)
